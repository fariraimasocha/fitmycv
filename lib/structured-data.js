...
export const organizationSchema = {
  ...
  name: "FitMyCV",
  url: SITE_URL,
  logo: `${SITE_URL}/fitmycv-logo.png`,
...
function buildOffers(pricing = PRICING) {
  return [
    {
      "@type": "Offer",
...
export function getSoftwareApplicationSchema(pricing = PRICING) {
  return {
    "@context": "https://schema.org",
    ...
    featureList: [
      ...
      "19 ATS-safe CV themes",
    ],
    offers: buildOffers(pricing),
  };
}
...
export function webPageSchema({ name, description, path = "/", about = true }) {
  ...
  return {
    ...
    primaryImageOfPage: `${SITE_URL}/hero-new.png`,
    publisher: { "@id": ORGANIZATION_ID },
