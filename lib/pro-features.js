// Every line maps to a real paywalled route. Keep it that way when editing.
export const PRO_FEATURES = [
  ...
  "Apply each ATS recommendation to your CV",
  "Draft answers for application form questions",
  "LinkedIn connection messages, and who to send them to",
];
