...
/**
 * Monday start dates for the last `weekCount` calendar weeks, oldest first.
 * Lines up index for index with buildWeeklyCounts so charts can label buckets.
 */
export function weekStartDates(weekCount, now) {
