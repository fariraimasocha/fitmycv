...
// "interviewing" as Interview. Relabelling avoids a data migration.
export const STAGES = [
  { key: "evaluated", label: "Saved" },
...
const CHIP = "border border-[var(--landing-line)]";
export const STAGE_STYLE = {
  evaluated: `${CHIP} bg-[var(--landing-paper-soft)] text-[var(--landing-ink-soft)]`,
  applied: `${CHIP} bg-[var(--landing-paper-soft)] text-[var(--landing-ink)]`,
  screening: `${CHIP} bg-[var(--landing-paper-strong)] text-[var(--landing-ink)]`,
  interviewing: `${CHIP} bg-[var(--landing-primary-soft)] text-[var(--landing-ink)]`,
  offer: `${CHIP} bg-[#eef8f1] text-[var(--landing-success)]`,
  rejected: `${CHIP} bg-[var(--landing-paper-soft)] text-[var(--landing-accent)]`,
  withdrawn: `${CHIP} bg-[var(--landing-paper-soft)] text-[var(--landing-ink-soft)]`,
};
