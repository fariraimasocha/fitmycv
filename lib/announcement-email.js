                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:20px;border-top:1px solid ${BRAND.accentLine};">
                      <tr>
                        <td style="padding-top:20px;">
                          <div class="em-ink" style="font-family:${FONT_SERIF};font-size:32px;line-height:1;color:${BRAND.ink};">$29.99<span class="em-ink-soft" style="font-family:${FONT_BODY};font-size:14px;font-weight:500;color:${BRAND.inkSoft};"> once</span></div>
                          ...
                          <div style="margin-top:18px;">
                            <a href="${escapeHtml(pricingUrl)}" target="_blank" class="em-cream" style="display:inline-block;background:${BRAND.accentDark};color:#ffffff;font-family:${FONT_UI};font-weight:600;font-size:15px;padding:14px 26px;border-radius:12px;text-decoration:none;">Get Lifetime for $29.99</a>
                          </div>
                          <div class="em-ink-soft" style="margin-top:12px;font-family:${FONT_BODY};font-size:12px;line-height:1.5;color:${BRAND.inkSoft};">Prefer monthly? That is $9.99, cancel anytime.</div>
                        </td>
                      </tr>
                    </table>
                  </td>
...
Lifetime is $29.99, paid once. No subscription, no renewal.
Prefer monthly? That is $9.99, cancel anytime.
