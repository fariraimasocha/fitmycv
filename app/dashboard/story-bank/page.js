...
export default function StoryBankPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 p-4 sm:p-6">
      ...
      >
        <h1 className="text-2xl font-bold font-outfit">Story Bank</h1>
      ...
      {!stories || stories.length === 0 ? (
        <Card className="rounded-2xl border shadow-lg">
          <CardContent className="py-10 text-center text-muted-foreground text-sm">
            <BookOpenIcon size={32} className="mx-auto mb-2 text-muted-foreground/50" />
            No stories saved yet. Tailor a resume and use the Interview Prep tab to generate stories,
            then save them here.
          </CardContent>
        </Card>
      ) : (
